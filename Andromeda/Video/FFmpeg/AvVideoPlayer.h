...
public:
	...
	bool getIsAudio() { return audio_stream_idx >= 0; }
...
private:
	...
	bool copy_to_pixels_vlocked( AvVideoData * data );
	AvVideoData * video_data_for_time_vlocked( double t );
	...
	vector<AvVideoData*> video_buffers;
